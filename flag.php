    ...
    if (empty($flag)) {
      ...
      if ($result) {
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          if ($flag == "apple" || $flag == "banana" || $flag == "potato") {
...
echo "<div style='position: absolute; top: 0; right: 0; width: 550px; height: 100px;'>";
...
echo "<button style='margin: 10px;' onclick='location.href=\"flag.php\"'>Flags</button>";
